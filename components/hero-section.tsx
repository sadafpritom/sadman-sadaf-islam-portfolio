...
import { Download, Mail, Github, Linkedin, Camera } from 'lucide-react';
...
export function HeroSection() {
  ...
  return (
    <section
      id="home"
      className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 pt-32 pb-16"
    >
      <div className="max-w-4xl mx-auto text-center">
        <div className="fade-in-up">
          ...
          {/* ✅ Centered text block */}
          <p className="text-lg sm:text-xl text-muted-foreground mb-8 max-w-3xl mx-auto text-center leading-relaxed">
            ...
            <span className="text-foreground font-medium">
              ...
              to harden all the modern security daily activity over the internet and dark web. I try to hack myself always!
            </span>
          </p>
        </div>
        ...
        <div className="stagger-container flex flex-wrap items-center justify-center gap-4 mb-12">
          <Button
            size="lg"
            className="stagger-animation glow-effect group"
            onClick={() =>
          ...
          <div className="flex space-x-2">
            <Button
              size="lg"
              variant="ghost"
              className="stagger-animation p-3 glass-card hover:bg-primary/10"
              onClick={() => window.open('https://www.linkedin.com/in/sadman-sadaf-islam/', '_blank')}
            >
            ...
            <Button
              ...
              variant="ghost"
              className="stagger-animation p-3 glass-card hover:bg-primary/10"
              onClick={() => window.open('https://github.com/sadafpritom', '_blank')}
            >
            ...
            <Button
              ...
              variant="ghost"
              className="stagger-animation p-3 glass-card hover:bg-primary/10"
              onClick={() => window.open('https://www.flickr.com/photos/197730320@N05/', '_blank')}
            >
